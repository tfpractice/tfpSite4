...
$(document).ready(function (){ 
 ...
 onePageScroll(".onePageScroll", {
   ...
   animationTime: 3000,             // AnimationTime let you define how long each section takes to animate
...
function onePageScroll(element, options) {
  ...
  this.init = function() { 
    ...
    /*-------------------------------------------*/
      ...
      pagination.setAttribute("id", "officialPagination");
...
(function() {
  $(function() {
    ...
    $(".projectLink").click(function() {
      var currentContents, currentDisplay, fslide, slider;
      ...
      fslide.resize();
      console.log(slider);
      return console.log(fslide);
    });
    $(".skillsDiv").hover(function() {
      var curSVG;
      curSVG = $(this).find(".canvasDiv");
      return curSVG.slideDown();
    });
    $(".skillsDiv").click(function() {
      var curSVG;
      curSVG = $(this).find(".canvasDiv");
      return curSVG.slideToggle();
    });
    $(".menuItem");
    return $("#archiveLink").click(function(event) {
      event.preventDefault();
      return window.open("http://tfpractice.tumblr.com/", "archive");
    });
  });
